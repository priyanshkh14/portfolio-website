...
export default function Contact() {
  ...
  return (
    <motion.section
      id="contact"
      ref={ref}
      className="flex w-full scroll-mt-12 flex-col items-center pb-16 pt-10 text-center dark:bg-darkBg dark:text-white"
      initial={{
        opacity: 0.8,
      }}
      whileInView={{
    ...
    >
      ...
      <div className="w-[min(100%,38rem)] px-4">
        <p className="mb-20 mt-6 text-gray-700 dark:text-white/80">
          ...
          <a className="underline" href="mailto:priyanshkh14@gmail.com">
            priyanshkh14@gmail.com
          </a>{" "}
